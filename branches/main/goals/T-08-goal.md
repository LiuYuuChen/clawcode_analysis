...
- [x] Pattern Audit task: 更新 instance-manifest.jsonl 中抽样实例的 role_source 为 verified
- [x] 验证 acceptance criteria（9/9 通过）
- [x] 识别风险与开放问题（6 风险 + 4 反模式 + 6 开放问题）
- [x] 更新 task 状态
- [x] 写出 task-analyses/T-08-mcp-integration.md（7 段追加，完整）
