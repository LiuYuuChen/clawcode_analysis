...
- [x] 写出 ## File Roles 强制节（85/85 scope files 全部列出）
- [x] 验证 acceptance criteria（7/7 PASS）
- [x] 识别风险与开放问题（7 problems + 8 open questions）
- [x] 写出 task-analyses/T-08-mcp-integration.md（52KB, 957 lines, 17 sections, 7 mermaid diagrams）
- [x] 清理临时文件
